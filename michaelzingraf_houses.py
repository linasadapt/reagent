...
BASE_SEARCH_URL = (
    ...
    "&region=1"
    "&sector=2,24,25,27"
    "&subtype=18,14"            # houses / villas / mansions
...
def scrape_zingraf_houses():
    ...
    while True:
        ...
        print(f"✅ Zingraf houses page {page} parsed")
        page += 1
